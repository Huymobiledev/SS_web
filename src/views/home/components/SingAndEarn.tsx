        ...
        >
          ...
          >
            ...
            >
              ...
              <img
                className="bigscreen"
                src="assets/images/singandearn/step1.png"
              />
              <Box
                sx={{
                  width: "100%",
                  background:
                    "radial-gradient(50% 50% at 50% 50%, #00000070 0%, rgba(0, 0, 0, 0) 100%)",
                  height: "17px",
                  mt: -7,
                  mb: 2,
                }}
              ></Box>
              <Typography className="bigscreenDetail" sx={{}}></Typography>
            </Grid>
            <Grid
              item
              md={1.7}
            ...
            >
              ...
              <img
                className="bigscreen"
                src="assets/images/singandearn/step2.png"
              />
              <Box
                sx={{
                  width: "100%",
            ...
            >
              ...
              <img
                className="bigscreen"
                src="assets/images/singandearn/step3.png"
              />
              <Box
                sx={{
                  width: "100%",
            ...
            >
              ...
              <img
                className="bigscreen"
                src="assets/images/singandearn/step4.png"
              />
              <Box
                sx={{
                  width: "100%",
