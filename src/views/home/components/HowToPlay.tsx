  ...
  return (
    <Box
      ...
      sx={{
        ...
        width: "100%",
        background:
          "linear-gradient(160deg, rgba(33,17,41,1) 0%, rgba(11,14,17,1) 37%, rgba(255,192,0,0.2) 63%, rgba(11,14,17,1) 100%)",
          ...
          <ScrollAnimation animateIn="fadeIn">
            ...
            >
              ...
              >
                ...
                <img
                  className="bigscreen"
                  src="assets/images/howtoplay/step1.png"
                />
              ...
              >
                ...
                <img
                  className="bigscreen"
                  src="assets/images/howtoplay/step2.png"
                />
                <Typography className="bigscreenDetail" sx={{}}>
                  CHOOSE A SONG
                </Typography>
              ...
              >
                ...
                <img
                  className="bigscreen"
                  src="assets/images/howtoplay/step3.png"
                />
                <Typography className="bigscreenDetail" sx={{}}>
                  START SINGING
                </Typography>
              ...
              >
                ...
                <img
                  className="bigscreen"
                  src="assets/images/howtoplay/step4.png"
                />
                <Typography className="bigscreenDetail" sx={{}}>
                  GET REWARDS
                </Typography>
