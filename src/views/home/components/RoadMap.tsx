...
export default function RoadMap () {
    ...
    return(
        <Box sx={{
            ...
            <Stack direction={'column'} gap={{xs: 5, md: 40}} sx={{width: '100%', mt: 5, display: 'flex', justifyContent: 'center', mb: 30}}>
            ...
            <Stack direction={'row'} sx={{
                ...
                <Stack direction={"column"} sx={{
                    ...
                    <Box sx={{
                        ...
                        <img src='assets/images/roadmap/Line2.svg' style={{position: 'absolute', top: '100px'}}/>
                        <Typography sx={{
                            fontFamily: 'Montserrat',
                ...
                <Stack direction={"column"}>
                    <Box sx={{
                        ...
                        <img src='assets/images/roadmap/Line2.svg' style={{position: 'absolute', transform: 'rotate(180deg)', bottom: '100px'}}/>
                        <Typography sx={{
                            fontFamily: 'Montserrat',
                            fontSize: {md: '14px', lg: '20px'},
                            fontWeight: 500,
                ...
                <Stack direction={"column"} sx={{
                    ...
                    <Box sx={{
                        ...
                        <img src='assets/images/roadmap/singer.png' style={{position: 'absolute', bottom: '200px', width: '130px'}}/>
                        <img src='assets/images/roadmap/Line2.svg' style={{position: 'absolute', top: '150px'}}/>
                        <Typography sx={{
                            fontFamily: 'Montserrat',
                            fontSize: {md: '14px', lg: '20px'},
                            fontWeight: 500,
                ...
                <Stack direction={"column"} sx={{}}>
                    <Box sx={{
                        ...
                        <Typography sx={{
                            ...
                            bottom: '200px',
                            transform: {md: 'translateX(-50px)', lg: 'translateX(-40px)'}
                        }}>
                            <ul>
                                <li>
            ...
            <Stack direction={"column"} gap={8} sx={{
                width: '90%',
                height: '1100px',
                mx: 'auto',
